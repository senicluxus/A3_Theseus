...
class Theseus_B_N_Truck_02_cargo_F: Truck_02_cargo_base_lxWS
{
	author = $STR_A3_A_Heliotrope;
	class SimpleObject
		{
...
class Theseus_B_N_Truck_02_flatbed_F: Truck_02_flatbed_base_lxWS
{
	...
	editorPreview = "\A3_Theseus\EditorPreviews_F_Theseus\Data\CfgVehicles\I_Truck_02_flatbed_F.jpg";
	scope = public;
	scopeCurator = public;
