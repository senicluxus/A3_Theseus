...
class B_Carryall_cbr_BNAmmo_F: B_Carryall_cbr
{
	author = $STR_A3_A_Heliotrope;
	scope = protected;
	class TransportMagazines
...
class B_Carryall_cbr_BNEng_F: B_Carryall_cbr
{
	author = $STR_A3_A_Heliotrope;
	scope = protected;
	class TransportMagazines
...
class B_TacticalPack_khk_BNMedic_F: B_TacticalPack_khk
{
	author = $STR_A3_A_Heliotrope;
	scope = protected;
	class TransportItems
...
class B_TacticalPack_khk_BNLAT_F: B_TacticalPack_khk
{
	author = $STR_A3_A_Heliotrope;
	scope = protected;
	class TransportMagazines
